...
c.NotebookApp.tornado_settings = {
    ...
    'headers': {
        'Content-Security-Policy': "frame-ancestors 'self' http://localhost:3000 https://bvdp-saturn-prod.appspot.com https://bvdp-saturn-dev.appspot.com; default-src 'self' ; script-src https://leonardo-fiab.dsde-dev.broadinstitute.org/ "
    }
}
