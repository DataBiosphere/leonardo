...
final class VPCInterpreter[F[_]: Parallel: ContextShift: StructuredLogger: Timer](
  ...
  private[algebra] def buildNetwork(project: GoogleProject): Network =
    Network
      .newBuilder()
  ...
  private[algebra] def buildSubnetwork(project: GoogleProject): Subnetwork =
    Subnetwork
      .newBuilder()
  ...
  private[algebra] def buildFirewall(googleProject: GoogleProject,
