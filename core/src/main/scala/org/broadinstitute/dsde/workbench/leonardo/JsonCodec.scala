...
object JsonCodec {
  ...
  implicit val googleIdEncoder: Encoder[GoogleId] = Encoder.encodeUUID.contramap(_.value)
  ...
  implicit val googleIdDecoder: Decoder[GoogleId] = Decoder.decodeUUID.map(GoogleId)
