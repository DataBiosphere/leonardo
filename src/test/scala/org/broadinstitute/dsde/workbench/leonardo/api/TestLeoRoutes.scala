...
trait TestLeoRoutes { this: ScalatestRouteTest =>
  ...
  val leonardoService = new LeonardoService(dataprocConfig, clusterResourcesConfig, proxyConfig, mockGoogleDataprocDAO, new MockGoogleIamDAO, DbSingleton.ref, clusterMonitorSupervisor, mockSamDAO)
