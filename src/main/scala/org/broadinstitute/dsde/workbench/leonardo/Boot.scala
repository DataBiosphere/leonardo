...
object Boot extends App with LazyLogging {
  private def startup(): Unit = {
    ...
    val contenSecurityPolicy = config.as[String]("jupyterContentSecurityPolicy.contentSecurityPolicy")
