...
object Boot extends App with LazyLogging {
  private def startup(): Unit = {
    ...
    val googleIamDAO = new HttpGoogleIamDAO(dataprocConfig.serviceAccount.value, clusterFilesConfig.leonardoServicePem.getAbsolutePath, dataprocConfig.applicationName, "google")
