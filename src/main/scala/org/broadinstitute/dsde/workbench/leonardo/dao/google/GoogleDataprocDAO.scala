...
trait GoogleDataprocDAO {
  ...
  def resizeCluster(googleProject: GoogleProject, clusterName: ClusterName, numWorkers: Option[Int] = None, numPreemptibles: Option[Int] = None, clusterServiceAccount: Option[WorkbenchEmail] = None): Future[Unit]
