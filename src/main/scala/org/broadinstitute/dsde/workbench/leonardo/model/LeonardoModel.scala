...
case class ClusterInitValues(googleProject: String,
                             ...
                             jupyterSafeModePluginUri: String,
                             jupyterEditModePluginUri: String,
...
object ClusterInitValues {
  ...
  def apply(googleProject: GoogleProject, clusterName: ClusterName, initBucketName: GcsBucketName, clusterRequest: ClusterRequest, dataprocConfig: DataprocConfig,
    ...
    ClusterInitValues(
      ...
      GcsPath(initBucketName, GcsObjectName(clusterResourcesConfig.jupyterSafeModePlugin.value)).toUri,
      GcsPath(initBucketName, GcsObjectName(clusterResourcesConfig.jupyterEditModePlugin.value)).toUri,
