...
# Test
JAVA_OPTS="-Dmysql.host=mysql -Dmysql.port=3306 -Xmx6G -Xms6G -Xss512m -XX:ReservedCodeCacheSize=128m" sbt -v -J-XX:MaxMetaspaceSize=1g "project http" clean assembly
