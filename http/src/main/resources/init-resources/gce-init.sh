...
#  }
  ...
  # Copy gitignore into jupyter container in the home directory (ask AOU?)
  docker exec -w $JUPYTER_USER_HOME $JUPYTER_SERVER_NAME /bin/bash -c "wget -N https://raw.githubusercontent.com/DataBiosphere/terra-docker/045a139dbac19fbf2b8c4080b8bc7fff7fc8b177/terra-jupyter-aou/gitignore_global"
