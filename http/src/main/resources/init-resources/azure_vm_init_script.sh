...
LEO_SERVICE_ACCOUNT_EMAIL=${21:-dummy}
...
echo "LEO_SERVICE_ACCOUNT_EMAIL = ${LEO_SERVICE_ACCOUNT_EMAIL}"
...
-e LISTENER_SETDATEACCESSEDINSPECTORPROPERTIES_LEONARDOSERVICEACCOUNTEMAIL=\"$LEO_SERVICE_ACCOUNT_EMAIL\" \
...
--env LISTENER_SETDATEACCESSEDINSPECTORPROPERTIES_LEONARDOSERVICEACCOUNTEMAIL=$LEO_SERVICE_ACCOUNT_EMAIL \
