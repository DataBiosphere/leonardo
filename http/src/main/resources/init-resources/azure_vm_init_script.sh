...
sudo runuser -l $VM_JUP_USER -c "wget -qP /home/$VM_JUP_USER/.jupyter https://raw.githubusercontent.com/DataBiosphere/leonardo/d7272a8af35ef408d166db71e6e976e6e044ab33/http/src/main/resources/init-resources/jupyter_server_config.py"
