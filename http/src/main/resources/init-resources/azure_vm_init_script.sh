...
LEONARDOURL="${18:-dummy}"
RUNTIMENAME="${19:-dummy}"
DATEACCESSEDSLEEPSECONDS=60 # supercedes default defined in terra-azure-relay-listeners/service/src/main/resources/application.yml
...
--env LISTENER_SETDATEACCESSEDINSPECTORPROPERTIES_SERVICEHOST=$LEONARDOURL \
--env LISTENER_SETDATEACCESSEDINSPECTORPROPERTIES_WORKSPACEID=$WORKSPACE_ID \
--env LISTENER_SETDATEACCESSEDINSPECTORPROPERTIES_CALLWINDOWINSECONDS=$DATEACCESSEDSLEEPSECONDS \
--env LISTENER_SETDATEACCESSEDINSPECTORPROPERTIES_RUNTIMENAME=$RUNTIMENAME \
