...
object DiskServiceDbQueries {
  ...
  def listDisks(labelMap: LabelMap, includeDeleted: Boolean, googleProjectOpt: Option[GoogleProject] = None)(implicit
    ec: ExecutionContext
  ...
  def getGetPersistentDiskResponse(googleProject: GoogleProject, diskName: DiskName, traceId: TraceId)(implicit
