...
class AKSInterpreter[F[_]](config: AKSInterpreterConfig,
  ...
  private[util] def buildCromwellRunnerChartOverrideValues(release: Release,
                                                           appName: AppName,
                                                           cloudContext: AzureCloudContext,
                                                           workspaceId: WorkspaceId,
                                                           landingZoneResources: LandingZoneResources,
  ...
  private[util] def mayCreateCromwellRunnerDatabases(app: App,
    ...
    for {
      ...
      cromwellRunnerDb <- createDatabaseInWsm(app, workspaceId, namespace, "cromwell-runner", wsmApi, None)
      tesDb <- createDatabaseInWsm(app, workspaceId, namespace, "tes", wsmApi, None)
