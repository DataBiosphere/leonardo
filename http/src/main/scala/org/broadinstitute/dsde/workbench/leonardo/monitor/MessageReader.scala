...
//}
abstract class LeoPubsubMessage(val updatedMachineConfig: MachineConfig, val clusterId: Long) {
  def messageType: String
}

final case class StopUpdateMessage(override val updatedMachineConfig: MachineConfig, override val clusterId: Long)
  extends LeoPubsubMessage(updatedMachineConfig: MachineConfig, clusterId: Long) {
