...
class RuntimeV2ServiceInterpSpec extends AnyFlatSpec with LeonardoTestSuite with TestComponent with MockitoSugar {
  ...
  it should "fail to list runtimes if user loses access to workspace" taggedAs LeonardoTags.SlickPlainQueryTest in isolatedDbTest {
    val userInfo = UserInfo(OAuth2BearerToken(""),
                            WorkbenchUserId("userId"),
                            WorkbenchEmail("user1@example.com"),
                            0
  ...
  it should "list runtimes with a workspace" taggedAs LeonardoTags.SlickPlainQueryTest in isolatedDbTest {
    val userInfo = UserInfo(OAuth2BearerToken(""),
                            WorkbenchUserId("userId"),
                            WorkbenchEmail("user1@example.com"),
                            0
  ...
  it should "list runtimes with a workspace and cloudContext" taggedAs LeonardoTags.SlickPlainQueryTest in isolatedDbTest {
    val userInfo = UserInfo(OAuth2BearerToken(""),
                            WorkbenchUserId("userId"),
                            WorkbenchEmail("user1@example.com"),
                            0
  ...
  it should "list runtimes with parameters" taggedAs LeonardoTags.SlickPlainQueryTest in isolatedDbTest {
    val userInfo = UserInfo(OAuth2BearerToken(""),
                            WorkbenchUserId("userId"),
                            WorkbenchEmail("user1@example.com"),
                            0
  ...
  it should "list runtimes belonging to other users" taggedAs LeonardoTags.SlickPlainQueryTest in isolatedDbTest {
    val userInfo = UserInfo(OAuth2BearerToken(""),
                            WorkbenchUserId("userId"),
                            WorkbenchEmail("user1@example.com"),
                            0
  ...
  it should "list runtimes with labels" taggedAs LeonardoTags.SlickPlainQueryTest in isolatedDbTest {
