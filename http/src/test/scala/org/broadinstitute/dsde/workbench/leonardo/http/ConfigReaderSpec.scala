...
class ConfigReaderSpec extends AnyFlatSpec with Matchers {
  it should "read config file correctly" in {
    ...
    val expectedConfig = AppConfig(
      TerraAppSetupChartConfig(ChartName("/leonardo/terra-app-setup"), ChartVersion("0.0.17")),
      PersistentDiskConfig(
        DiskSize(30),
        DiskType.Standard,
        BlockSize(4096),
      ...
      AzureConfig(
        AzurePubsubHandlerConfig(
          ...
          AzureRuntimeDefaults(
            ...
            "terradevacrpublic.azurecr.io/terra-azure-relay-listeners:7332379",
