  ...
  it should "encode CreateVmRequest" in {
    ...
    req shouldBe
      s"""
         ...
         |      "protectedSettings": [{
         |          "key": "fileUris",
         |          "value": ["https://raw.githubusercontent.com/DataBiosphere/leonardo/39d0ec189c007e44b853fc4668122cbed0bc09ac/http/src/main/resources/init-resources/azure_vm_init_script.sh"]
         |        },
         |        {
