...
gcloud compute scp ${LEO_JAR_PATH} ${FIAB}:/tmp --zone=us-central1-a --project broad-dsde-${ENV}
...
gcloud compute ssh --project broad-dsde-${ENV} --zone us-central1-a ${FIAB} -- 'sudo docker exec -it firecloud_leonardo-app_1 sh -c "rm -f /leonardo/*jar"'
