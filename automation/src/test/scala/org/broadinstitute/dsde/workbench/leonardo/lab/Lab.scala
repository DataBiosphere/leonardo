...
import org.broadinstitute.dsde.workbench.leonardo.{ClusterNameCopy, ContentItem, LeonardoConfig}
...
object Lab extends RestClient with LazyLogging {
  ...
  def labPath(googleProject: GoogleProject, clusterName: ClusterNameCopy): String =
