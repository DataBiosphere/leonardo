...
object Dependencies {
  ...
  def excludeSpringframeworkAop = ExclusionRule("org.springframework.aop")
  ...
  def tclExclusions(m: ModuleID): ModuleID = m.excludeAll(excludeSpringframework, excludeSpringBoot, excludeSpringAop, excludeSpringframeworkAop, excludeSpringData, excludeOpenCensus, excludeGoogleFindBugs, excludeBroadWorkbench, excludePostgresql, excludeSnakeyaml, excludeSlf4j)
