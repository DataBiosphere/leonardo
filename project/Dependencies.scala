...
object Dependencies {
  ...
  private val workbenchLibsHash = "311c84b"
  val serviceTestV = "1.1-73b77c5" //s"2.0-$workbenchLibsHash"
  ...
  val coreDependencies = List(
    ...
    helmScalaSdk,
    helmScalaSdkTest,
    "net.logstash.logback" % "logstash-logback-encoder" % "7.1", // for structured logging in logback
