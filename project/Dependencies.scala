...
object Dependencies {
  ...
  val googleRpc: ModuleID =                 "io.grpc"         % "grpc-core"                       % "1.38.1" excludeAll (excludeGuava, excludeGson, excludeFindbugsJsr)
  ...
  val googleCloudNio: ModuleID =  "com.google.cloud"    % "google-cloud-nio"      % "0.123.3" % Test // brought in for FakeStorageInterpreter
