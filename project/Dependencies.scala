...
object Dependencies {
  ...
  val swaggerUi: ModuleID =       "org.webjars"                 % "swagger-ui"      % "3.47.1"
  ...
  val mysql: ModuleID =           "mysql"               % "mysql-connector-java"  % "8.0.24"
  val liquibase: ModuleID =       "org.liquibase"       % "liquibase-core"        % "4.3.2"
  val sealerate: ModuleID =       "ca.mrvisser"         %% "sealerate"            % "0.0.6"
  val googleCloudNio: ModuleID =  "com.google.cloud"    % "google-cloud-nio"      % "0.122.12" % Test // brought in for FakeStorageInterpreter
