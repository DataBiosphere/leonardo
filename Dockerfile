...
COPY ./workflows-app-0.171.0.tgz /leonardo
RUN tar -xzf /leonardo/workflows-app-0.171.0.tgz -C /leonardo

COPY ./cromwell-runner-app-0.110.0.tgz /leonardo
RUN tar -xzf /leonardo/cromwell-runner-app-0.110.0.tgz -C /leonardo
