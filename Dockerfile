...
ENV CROMWELL_CHART_VERSION 0.2.217
ENV CROWELL_ON_AZURE_CHART_VERSION 0.2.217
...
COPY ./cromwell-on-azure-0.2.219.tgz /leonardo
RUN tar -xzf /leonardo/cromwell-on-azure-0.2.219.tgz -C /leonardo
