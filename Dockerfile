...
COPY ./workflows-app-0.161.0.tgz /leonardo
RUN tar -xzf /leonardo/workflows-app-0.161.0.tgz -C /leonardo

COPY ./cromwell-runner-app-0.108.0.tgz /leonardo
RUN tar -xzf /leonardo/cromwell-runner-app-0.108.0.tgz -C /leonardo
