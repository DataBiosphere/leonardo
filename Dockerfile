...
ENV CROMWELL_CHART_VERSION 0.2.336
ENV CROWELL_ON_AZURE_CHART_VERSION 0.2.336
...
COPY ./wds-0.43.1.tgz /leonardo
RUN tar -xzf /leonardo/wds-0.43.1.tgz -C /leonardo
