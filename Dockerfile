...
ENV CROMWELL_CHART_VERSION 0.2.502
ENV HAIL_BATCH_CHART_VERSION 0.2.0
ENV RSTUDIO_CHART_VERSION 0.6.0
...
COPY ./workflows-app-0.220.0.tgz /leonardo
RUN tar -xzf /leonardo/workflows-app-0.220.0.tgz -C /leonardo
RUN cd /leonardo && \
    helm repo update && \
