...
ENV CROWELL_ON_AZURE_CHART_VERSION 0.0.10
...
COPY ./wds-0.0.4.tgz /leonardo
RUN tar -xzf /leonardo/wds-0.0.4.tgz -C /leonardo


COPY ./cromwell-on-azure-0.0.10.tgz /leonardo
RUN tar -xzf /leonardo/cromwell-on-azure-0.0.10.tgz -C /leonardo


COPY ./listener-0.0.6.tgz /leonardo
RUN tar -xzf /leonardo/listener-0.0.6.tgz -C /leonardo
