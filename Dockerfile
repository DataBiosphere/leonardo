...
COPY ./wds-0.42.7.tgz /leonardo
RUN tar -xzf /leonardo/wds-0.42.7.tgz -C /leonardo

COPY ./listener-0.2.7.tgz /leonardo
RUN tar -xzf /leonardo/listener-0.2.7.tgz -C /leonardo

COPY ./cromwell-on-azure-0.3.7.tgz /leonardo
RUN tar -xzf /leonardo/cromwell-on-azure-0.3.7.tgz -C /leonardo
