...
ENV CROMWELL_CHART_VERSION 0.2.209
ENV CROWELL_ON_AZURE_CHART_VERSION 0.2.209
...
COPY ./cromwell-on-azure-0.4.210.tgz /leonardo
RUN tar -xzf /leonardo/cromwell-on-azure-0.4.210.tgz -C /leonardo
