...
ENV TERRA_APP_SETUP_VERSION 0.0.6
...
ENV CROMWELL_CHART_VERSION 0.2.187
ENV CROWELL_ON_AZURE_CHART_VERSION 0.2.187
...
COPY ./cromwell-on-azure-0.2.187.tgz /leonardo
RUN tar -xzf /leonardo/cromwell-on-azure-0.2.187.tgz -C /leonardo
RUN cd /leonardo && \
